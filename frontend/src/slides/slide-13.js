...
01010011 01111001 01110011 01110100 01100101
    ...
    <svg style="position: absolute; width: 100%; height: 100%; opacity: 0.2;">
      <defs>
        <pattern id="matrix-grid-13" x="0" y="0" width="50" height="50" patternUnits="userSpaceOnUse">
          <rect x="0" y="0" width="50" height="50" fill="none" stroke="#00ff00" stroke-width="0.5"/>
        </pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#matrix-grid-13)"/>
    </svg>
  ...
  <style>
    ...
    @keyframes float-code { 0%, 100% { transform: translateY(0px); opacity: 0.4; } 50% { transform: translateY(-18px); opacity: 0.6; } }
  </style>
</div>
`);
